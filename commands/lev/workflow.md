...
lev assess-personality --context="[situation]" --complexity=0.8
→ Constitutional AI selects best personality for task

# Switch personality mode
lev switch-personality --from="ntp_innovator" --to="stp_adapter"
→ Dynamic context switching for different reasoning approach

# Validate personality alignment
lev validate-alignment --personality="sfj_caregiver" --principles="constitutional"
→ Ensure personality selection aligns with constitutional framework

# Multi-personality synthesis
lev synthesize --personalities="all" --convergence-threshold=0.8
...
lev load-context --type="agent" --id="cortisol_guardian" --step="analysis"
→ Assemble context files and personality instructions

# Execute context switching sequence
lev context-sequence --workflow="deep-analysis" --personalities="auto-select"
→ Optimal personality sequence for complex analysis

# Context relationship mapping
lev map-contexts --source="constitutional-ai" --depth=3
→ Discover related contexts and optimal combination patterns

# Context validation and integrity
lev validate-contexts --workflow="[workflow-name]" --check-dependencies=true
...
lev constitutional-analysis --target="new-tool-evaluation"

# Multi-personality deliberation
lev cognitive-parliament --topic="architecture-decision" --urgency="high"

# Bidirectional flow for complex problems
lev bidirectional --problem="mastra-integration-strategy" --depth=5

# Stress reduction protocol
lev cortisol-reduction --situation="overwhelming-technical-complexity"

# Personality optimization
lev assess-personality --context="creative-problem-solving" --output-verbosity="medium"

# Workflow performance analysis
lev analytics --timeframe="last-week" --metrics="emergence,compliance,efficiency"
```
